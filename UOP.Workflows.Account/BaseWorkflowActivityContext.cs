...
{
    class BaseWorkflowActivityContext : IExtendedExecutionContext
    {
        ...
        public BaseWorkflowActivityContext(CodeActivityContext activityContext, BaseWorkflow workflow)
        {
        ...
        public Entity PreImageEntity => _workflowContext.PreEntityImages[PreBusinessEntity];

        public Entity PostImageEntity => _workflowContext.PostEntityImages[PostBusinessEntity];
